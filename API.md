...
| [`workflowBootstrapSteps`](#deployableawscdkapptsdeployableawscdktypescriptappoptionspropertyworkflowbootstrapsteps) | [`projen.github.workflows.JobStep`](#projen.github.workflows.JobStep)[] | Workflow steps to use in order to bootstrap this repo. |
...
| [`synth`](#deployableawscdkapptsdeployableawscdktypescriptappsynth) | Synthesize all project files into `outdir`. |
