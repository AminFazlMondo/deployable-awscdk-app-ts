...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptApp.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptApp.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptApp.with.parameter.mixins"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptApp.property.biome"></a>
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.projectTree">projectTree</a></code> | <code>boolean</code> | Generate a project tree file (`.projen/tree.json`) that shows all components and their relationships. Useful for understanding your project structure and debugging. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.config">config</a></code> | <code>{[ key: string ]: any}</code> | Configuration values available to package scripts at runtime. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.npmTrustedPublishing">npmTrustedPublishing</a></code> | <code>boolean</code> | Use trusted publishing for publishing to npmjs.com Needs to be pre-configured on npm.js to work. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.cdkCliVersion">cdkCliVersion</a></code> | <code>string</code> | Version range of the AWS CDK CLI to depend on. |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.app">app</a></code> | <code>string</code> | The command line to execute in order to synthesize the CDK application (language specific). |
...
| <code><a href="#deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.experimentalIntegRunner">experimentalIntegRunner</a></code> | <code>boolean</code> | Enable experimental support for the AWS CDK integ-runner. |
...
##### `projectTree`<sup>Optional</sup> <a name="projectTree" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.projectTree"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.bunVersion"></a>
...
##### `config`<sup>Optional</sup> <a name="config" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.config"></a>
...
##### `npmProvenance`<sup>Optional</sup> <a name="npmProvenance" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.npmProvenance"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.npmTrustedPublishing"></a>
...
##### `yarnBerryOptions`<sup>Optional</sup> <a name="yarnBerryOptions" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.yarnBerryOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.bumpPackage"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.nextVersionCommand"></a>
...
##### `releasableCommits`<sup>Optional</sup> <a name="releasableCommits" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.releasableCommits"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.releaseWorkflowEnv"></a>
...
##### ~~`workflowRunsOnGroup`~~<sup>Optional</sup> <a name="workflowRunsOnGroup" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.workflowRunsOnGroup"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.biomeOptions"></a>
...
##### `buildWorkflowOptions`<sup>Optional</sup> <a name="buildWorkflowOptions" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.buildWorkflowOptions"></a>
...
##### `checkLicenses`<sup>Optional</sup> <a name="checkLicenses" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.checkLicenses"></a>
...
##### `workflowPackageCache`<sup>Optional</sup> <a name="workflowPackageCache" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.workflowPackageCache"></a>
...
##### `tsJestOptions`<sup>Optional</sup> <a name="tsJestOptions" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.tsJestOptions"></a>
...
##### `cdkCliVersion`<sup>Optional</sup> <a name="cdkCliVersion" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.cdkCliVersion"></a>
...
##### `app`<sup>Optional</sup> <a name="app" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.app"></a>
...
##### `experimentalIntegRunner`<sup>Optional</sup> <a name="experimentalIntegRunner" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.experimentalIntegRunner"></a>
...
##### `singletonLambdaAutoDiscover`<sup>Optional</sup> <a name="singletonLambdaAutoDiscover" id="deployable-awscdk-app-ts.DeployableAwsCdkTypeScriptAppOptions.property.singletonLambdaAutoDiscover"></a>
